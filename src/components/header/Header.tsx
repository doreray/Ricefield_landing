...
export function LandingPageHeader() {
  ...
  const visitRicefield = () => {
    window.open("https://www.joinricefield.com/", "_blank");
  };
    ...
    <div className={styles.headerStretch}>
      <div className={styles.headerLanding}>
        ...
        <div className={styles.headerButtons}>
          ...
          <div className={styles.groupContainer}>
            <div className={styles.viewPrototype}>
              <b className={styles.b2} onClick={handleJoinWaitlistClick}>
                Join Waitlist
              </b>
            </div>
          </div>
          ...
          >
            <div className={styles.joinWaitlistButton1}>
              <div className={styles.joinTheWaitlist}>Visit Ricefied</div>
            </div>
          </div>
        </div>
